...
";
    ...
    /// 发送更新可用通知
    /// </summary>
    public void ShowUpdateAvailableNotification(string version, string releaseNotes)
    {
        string title = "发现新版本";
        string message = $"ImmersingPicker {version} 已发布!\n\n{TruncateText(releaseNotes, 100)}\n\n打开设置检查更新";
    ...
    /// 发送更新下载完成通知
    /// </summary>
    public void ShowUpdateDownloadedNotification()
    {
        string title = "更新已下载完成";
        string message = "ImmersingPicker 更新已下载完成,准备安装。";
    ...
    /// 发送更新失败通知
    /// </summary>
    public void ShowUpdateFailedNotification(string errorMessage)
    {
        string title = "更新失败";
        string message = $"ImmersingPicker 更新失败: {TruncateText(errorMessage, 150)}";
